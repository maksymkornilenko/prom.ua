<?php
define('AUTH_TOKEN', 'd35991b0df84e8c74c21f8081ca6429edf10444c');  // Your authorization token
...
// echo var_dump($order);
$set_status_result = $client->set_order_status((array) $order_id, 'canceled', 'not_enough_fields', 'not_enough_fields');
